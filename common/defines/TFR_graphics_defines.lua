...
NDefines.NGraphics.CAMERA_ZOOM_SPEED_DISTANCE_MULT = 15
...
NDefines_Graphics.NGraphics.AIRBASE_ICON_DISTANCE_CUTOFF = 798
...
NDefines_Graphics.NGraphics.VICTORY_POINTS_DISTANCE_CUTOFF = {200, 450, 600}
...
NDefines_Graphics.NGraphics.DRAW_FOW_CUTOFF = 0 		-- 25 above GB_CAM_MAX. Prevents transitional luminance flicker.
NDefines_Graphics.NGraphics.DRAW_FOW_FADE_LENGTH = 0
