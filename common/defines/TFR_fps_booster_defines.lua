...
NDefines.NGraphics.MAP_BUILDINGS_SHRINK_DISTANCE = 0 -- Default 180. Civilian 3D buildings disabled.
NDefines.NGraphics.CITY_SPRAWL_SHRINK_DISTANCE = 0 -- Default 220. City sprawl textures disabled.
