...
NGame = {
	...
	GAME_SPEED_SECONDS = { 50, 0.5, 0.2, 0.1, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NProduction = {
	...
	LICENSE_EQUIPMENT_BASE_SPEED = 0,				-- base MIC speed modifier for licensed equipment
...
NMilitary = {
	...
	BASE_DIVISION_BRIGADE_GROUP_COST = 2, 	--Base cost to unlock a regiment slot,    10
	...
	ENEMY_AIR_SUPERIORITY_IMPACT = -0.10,          -- effect on defense due to enemy air superiorty     was -0.35
	ENEMY_AIR_SUPERIORITY_DEFENSE = 0.80,	       -- more AA attack will approach this amount of help (diminishing returns)	was 0.7
	ENEMY_AIR_SUPERIORITY_DEFENSE_STEEPNESS = 112, -- how quickly defense approaches the max impact diminishing returns curve   
	ENEMY_AIR_SUPERIORITY_SPEED_IMPACT = 0.0,     -- effect on speed due to enemy air superiority was -0.3

	ANTI_AIR_TARGETTING_TO_CHANCE = 0.09,			-- was 0.07  Balancing value to determine the chance of ground AA hitting an attacking airplane, affecting both the effective average damage done by AA to airplanes, and the reduction of damage done by airplanes due to AA support
	ANTI_AIR_ATTACK_TO_AMOUNT = 0.008,				-- Balancing value to convert equipment stat anti_air_attack to the random % value of airplanes being hit.  was 0.005
	...
	TRAINING_ATTRITION = 0.00,		  			   -- amount of extra attrition from being in training
...
NAir = {
	...
	AA_INDUSTRY_AIR_DAMAGE_FACTOR = -0.18,				-- 5x levels = 60% defense from bombing
