...
NDefines.NMilitary.COMBAT_OVER_WIDTH_PENALTY = -2.5				-- how much penalty for each width over the limit (so if you have 10 width and the limit is 7, you get 3*3=9 penalty)
